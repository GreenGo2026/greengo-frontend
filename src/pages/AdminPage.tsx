...
function PriceRow({item,rowIndex,totalRows,lang,onChange,onToggle,onSave,inputRef,onToggleSale,onDiscountChange,onDescChange}:{item:EditableProduct;rowIndex:number;totalRows:number;lang:Lang;onChange:(id:string,val:number)=>void;onToggle:(id:string,val:boolean)=>void;onToggleSale:(id:string)=>void;onDiscountChange:(id:string,val:number)=>void;onDescChange:(id:string,val:string)=>void;onSave:(id:string)=>void;inputRef:(el:HTMLInputElement|null)=>void;totalRows:number;rowIndex:number}) {
