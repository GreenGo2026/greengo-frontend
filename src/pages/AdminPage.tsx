...
function PriceRow({item,rowIndex,totalRows,lang,onChange,onToggle,onSave,inputRef,onToggleSale,onDiscountChange,onDescChange}:{item:EditableProduct;rowIndex:number;totalRows:number;lang:Lang;onChange:(id:string,val:number)=>void;onToggle:(id:string)=>void;onSave:(id:string)=>void;inputRef:(el:HTMLInputElement|null)=>void;}){
